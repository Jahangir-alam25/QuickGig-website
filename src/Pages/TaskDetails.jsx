...
const TaskDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://a10-freelance-task-marketplace-server-ph.vercel.app/bids?taskId=${_id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleBid = () => {
    ...
    fetch("https://a10-freelance-task-marketplace-server-ph.vercel.app/bids", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="bg-amber-50 dark:text-white dark:bg-gray-800 p-4">
      <Helmet>
        <title>Task Details - QuickGig</title>
      </Helmet>
      ...
      <div className="  flex justify-center items-center py-12">
        ...
        <div className="w-full max-w-xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-blue-100 hover:shadow-blue-300 transition-all duration-300 p-6">
          <div className="mb-4 text-center">
            <h2 className="text-3xl font-extrabold">🚀 {title}</h2>
            <p className="text-gray-500 dark:text-gray-300">Posted by {userName}</p>
          </div>
